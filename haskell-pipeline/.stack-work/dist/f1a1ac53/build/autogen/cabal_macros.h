...
/* package haskell-pipeline-0.1.0.0 */
#ifndef VERSION_haskell_pipeline
#define VERSION_haskell_pipeline "0.1.0.0"
#endif /* VERSION_haskell_pipeline */
#ifndef MIN_VERSION_haskell_pipeline
#define MIN_VERSION_haskell_pipeline(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_pipeline */
...
#define CURRENT_PACKAGE_KEY "haskell-pipeline-0.1.0.0-8B4Cc59W3Rk7NtQwdPuwXe"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-pipeline-0.1.0.0-8B4Cc59W3Rk7NtQwdPuwXe"
